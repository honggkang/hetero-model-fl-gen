...
from utils.localUpdateGenF import LocalUpdate_DDPMF
...
from DDPM.ddpm16 import *  # DDPM.ddpm14 features  / DDPM.ddpm16 features / DDPM.ddpm28 orig/feat / DDPM.ddpm32 orig
...
def main():
    ...
    for iter in range(1, args.gen_wu_epochs+1):
        ...
        idxs_users = user_select(args)
        for idx in idxs_users:                        
            local = LocalUpdate_DDPMF(args, common_net, dataset=dataset_train, idxs=dict_users[idx])
            if args.freeze_gen:
    ...
    for iter in range(1,args.epochs+1):
        ...
        for idx in idxs_users:
            ...
            if args.only_gen: # update header only by synthetic data
            ...
            else: # update header by syn+real data
